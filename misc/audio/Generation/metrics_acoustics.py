...
DIR_PATH_AUDIO = "/lustre/fsn1/projects/rech/rtl/uaj63yz/JSALT2025/sdialog/misc/audio/Generation/outputs-voices-libritts-indextts+dscaper+acoustics+metadata"

for dir_dialog in os.listdir(DIR_PATH_AUDIO):

    dialog_id = dir_dialog.split("_")[0]
    print(dialog_id)

    # Get the exported audios paths
    path_exported = os.path.join(DIR_PATH_AUDIO, dir_dialog, "exported_audios")
    ...
    path_utterances = os.path.join(DIR_PATH_AUDIO, dir_dialog, "utterances")
