...
#SBATCH --output=./logs_slurm/SDialogIndexTTS-%j.out # nom du fichier de sortie
#SBATCH --error=./logs_slurm/SDialogIndexTTS-%j.err  # nom du fichier d'erreur (ici commun avec la sortie)
