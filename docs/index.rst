...
See `SDialog Github page <https://github.com/idiap/sdialog/>`_ for more info. We welcome issues, feature requests, and pull requests. If you want to **contribute to the project**, please open an `issue <https://github.com/idiap/sdialog/issues>`_ or submit a PR, and help us make SDialog better 👍
