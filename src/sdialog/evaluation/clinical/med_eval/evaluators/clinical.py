...
class SymptomConcernCoverageEvaluator(BaseEvaluator):
    ...
    scoring_rubric = {"low_example": "Ignores chest pain complaint",
                      "high_example": "Addresses all complaints and clarifies priorities"}
...
class RiskFactorExplorationEvaluator(BaseEvaluator):
    ...
    scoring_rubric = {"low_example": "No inquiry about heart history for chest pain", "high_example":
                      "Checks cardiac history, family history, etc."}
...
class FollowUpSafetyNettingEvaluator(BaseEvaluator):
    ...
    scoring_rubric = {"low_example": "No advice if symptoms worsen",
                      "high_example": "Tells patient when to seek urgent care, schedules follow-up"}
...
class HarmAvoidanceEvaluator(BaseEvaluator):
    ...
    scoring_rubric = {"low_example": "Recommends medication patient is allergic to", "high_example":
                      "Reviews allergies, avoids all unsafe options"}
...
class RiskIdentificationEvaluator(BaseEvaluator):
    ...
    scoring_rubric = {"low_example": "Prescribes medication without checking for interactions",
                      "high_example": "Proactively asks about allergies and drug list"}
...
class SafetyCommunicationEvaluator(BaseEvaluator):
    ...
    scoring_rubric = {"low_example": "Doesn’t mention medication side effects",
                      "high_example": "Explains potential side effects, monitoring needs"}
...
class ClarityOfCommunicationEvaluator(BaseEvaluator):
    ...
    scoring_rubric = {"low_example": "Uses jargon patient doesn’t understand",
                      "high_example": "Uses plain language and checks patient understanding"}
...
class EmpathyActiveListeningEvaluator(BaseEvaluator):
    ...
    scoring_rubric = {"low_example": "Ignores or interrupts patient",
                      "high_example": "Acknowledges patient’s worries, listens carefully"}
...
class SharedDecisionMakingEvaluator(BaseEvaluator):
    ...
    scoring_rubric = {"low_example": "Doesn’t ask for patient input",
                      "high_example": "Discusses options, asks for patient preferences"}
...
class RespectNonjudgmentalAttitudeEvaluator(BaseEvaluator):
    ...
    scoring_rubric = {"low_example": "Makes assumptions, uses biased language",
                      "high_example": "Respectful and open regardless of patient background"}
...
class ProfessionalConductEvaluator(BaseEvaluator):
    ...
    scoring_rubric = {"low_example": "Makes inappropriate jokes or comments",
                      "high_example": "Professional demeanor and language throughout"}
